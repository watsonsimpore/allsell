<main id="main">
	<div class="container">
			...
			<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
				...
				<div class="item-slide">
					...
					<div class="slide-info slide-1">
						...
						<p class="sale-info">Seulement à: <span class="price">{{$slide->price}} FCFA</span></p>
						<a href="{{$slide->link}}" class="btn-link">Payer</a>
					</div>
				</div>
				@endforeach
			</div>
		...
		<div class="wrap-banner style-twin-default">
			@foreach($s_sliders as $s_slide)
				<div class="banner-item">
					<a href="{{$s_slide->link}}" class="link-banner banner-effect-1">
						<figure><img src="{{ asset('assets/images/sliders') }}/{{$s_slide->image}}" alt="" width="580" height="190"></figure>				
					</a>				
				</div>
			@endforeach
		</div>
			...
			<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
				...
				<div class="product product-style-2 equal-elem ">
					<div class="product-thumnail">
						...
						<div class="wrap-btn">
							<a href="{{route('product.details',['slug'=>$sproduct->slug])}}" class="function-link">Voir</a>
						</div>
		...
		<div class="wrap-show-advance-info-box style-1">
			...
			<div class="wrap-top-banner">
				@foreach($lastedbanners as $lastedbanner)
					<a href="{{$lastedbanner->link}}" class="link-banner banner-effect-2">
						<figure><img src="{{ asset('assets/images/sliders') }}/{{$lastedbanner->image}}" width="1170" height="240" alt=""></figure>
					</a>
				@endforeach
			</div>
							...
							<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
								...
								<div class="product product-style-2 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">{{$lproduct->regular_price}} FCFA</span></div>
									</div>
								</div>
								@endforeach
							</div>
		...
		<!-- Product Categories -->
		<div class="wrap-show-advance-info-box style-1">
			<h3 class="title-box">categorie de Produits</h3>
			<div class="wrap-top-banner">
				@foreach($catbanners as $catbanner)
					<a href="{{$catbanner->link}}" class="link-banner banner-effect-2">
						<figure><img src="{{ asset('assets/images/sliders') }}/{{$catbanner->image}}" width="1170" height="240" alt=""></figure>
					</a>
				@endforeach
			</div>
			<div class="wrap-products">
				<div class="wrap-product-tab tab-style-1">
					<div class="tab-control">
						...
						<a href="#categroy_{{$category->id}}" class="tab-control-item {{$key==0? 'active':''}}">{{$category->name}}</a>
						@endforeach
					</div>
					<div class="tab-contents">
						@foreach ($categories as $key=>$category)
						<div class="tab-content-item {{$key==0? 'active':''}}" id="categroy_{{$category->id}}">
							<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
								...
								<div class="product product-style-2 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">{{$c_product->regular_price}} FCFA</span></div>
									</div>
								</div>
								@endforeach
							</div>
