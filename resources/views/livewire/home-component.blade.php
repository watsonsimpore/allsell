        ...
        <div class="wrap-banner style-twin-default">
            ...
            <div class="banner-item">
                <a href="{{$s_slide->link}}" class="link-banner banner-effect-1">
                    <figure><img src="{{ asset('assets/images/sliders') }}/{{$s_slide->image}}" alt="" width="580"
                            height="190"></figure>
                </a>
            </div>
            @endforeach
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                ...
                <a href="{{$lastedbanner->link}}" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/sliders') }}/{{$lastedbanner->image}}" width="1170"
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                ...
                <a href="{{$catbanner->link}}" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/sliders') }}/{{$catbanner->image}}" width="1170"
                            height="240" alt=""></figure>
                </a>
                @endforeach
            </div>
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span
                                                class="product-price">{{$c_product->regular_price}} FCFA</span></div>
                                    </div>
                                </div>
                                @endforeach
                            </div>
