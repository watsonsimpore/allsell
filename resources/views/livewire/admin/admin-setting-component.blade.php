            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" wire:submit.prevent="saveSettings">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" placeholder="Telephone" class="form-control input-md" wire:model="phone"/>
                            @error('phone') <p class="text-danger">{{$message}}</p> @enderror
                        </div>                        
                    </div>

                    <div class="form-group">
                        <label class="col-md-4 control-label">Telephone 2</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="Telephone 2" class="form-control input-md" wire:model="phone2"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" placeholder="Adresse" class="form-control input-md" wire:model="adress"/>
