            ...
            <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                             <a href="{{route('admin.orders')}}" class="btn btn-success pull-right">Les Commandes</a>                
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="wrap-iten-in-cart">
                                ...
                                <ul class="products-cart">
                                    ...
                                    <li class="pr-cart-item">
                                        ...
                                        @endif
                                        <div class="price-field produtc-price"><p class="price">{{$item->product->regular_price}} FCFA</p></div>
                                        <div class="quantity">
                                            <h5>{{$item->quantity}}</h5>
                                        </div>
